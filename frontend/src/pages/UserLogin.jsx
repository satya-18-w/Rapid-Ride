        ...
        <div className='min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden'>
            ...
            <div className='w-full max-w-md relative z-10'>
                ...
                <div className='relative bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-gray-800/50'>
                    {/* Back Button */}
                    <Link to="/" className='inline-flex items-center text-gray-500 hover:text-lime-400 mb-6 transition-colors text-sm font-medium'>
                    ...
                    <div className='mb-8 text-center'>
                        <div className='inline-block p-3 bg-gradient-to-br from-lime-400 to-emerald-500 rounded-2xl mb-4 shadow-lg shadow-lime-500/20'>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className='w-full pl-4 pr-12 py-3 bg-black/50 border border-gray-700 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-lime-500 focus:ring-1 focus:ring-lime-500 transition-all'
                    ...
                    <div className='mt-8 text-center space-y-4'>
                        <p className='text-sm text-gray-400'>
                            ...
                            <Link to="/user/signup" className='text-lime-400 font-semibold hover:text-lime-300 transition-colors'>
                                Sign up
                            </Link>
                        </p>
                        ...
                        <div className="pt-4 border-t border-gray-800">
                            ...
                            >
                                ...
                                <span className="text-emerald-500 font-semibold hover:text-emerald-400">Login as Captain →</span>
                            </Link>
                        </div>
                    </div>
                </div>
