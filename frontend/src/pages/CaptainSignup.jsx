...
const CaptainSignup = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await signup({ ...formData, role: 'driver' });
                ...
                <div className='relative bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-gray-800/50'>
                    ...
                    <div className='mt-8 text-center'>
                        <p className='text-sm text-gray-400'>
                            Already a Captain?{' '}
                            <Link to="/driver/login" className='text-emerald-400 font-semibold hover:text-emerald-300 transition-colors'>
                                Sign in
                            </Link>
                        </p>
                    </div>
